...
Same PROF as Requirements Engineering. Course content probably boring and not directly applicable.
...
Students should have knowledge of Fourier series. Requires restudying MATH 1005
...
PREREQ - **SYSC 4602 (Which if a fall course only)** 
...
This course will follow “The One Hundred Page Machine Learning Book” from cover-to-
cover. Students will gain an introductory-level understanding of both supervised and
unsupervised machine learning (ML), including deeper knowledge of a number of
algorithms of each type. Students will learn how to evaluate and quantify predictive
performance of ML systems. Students will also become familiar with one or more ML
development environments with practical assignments and demonstrations.
...
*Priority to 4th year BCS students.*
...
*Requires registration override request*
**PREREQ: SYSC 4415 (Introduction to Machine Learning)**
